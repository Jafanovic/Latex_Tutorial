...
% Since the OP asks for creating an animated PDF using the animate package without the need to have
% the animation frames in a separate (PDF) file, the tikzpicture environment can be directly put into
% an animateinline environment:
